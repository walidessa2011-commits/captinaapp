...
export default function TaekwondoPage() {
    ...
    const content = t('taekwondoContent');
                    ...
                    <div className="max-w-7xl mx-auto flex flex-col items-start gap-2">
                        ...
                        >
                            ...
                            <span className="text-[10px] md:text-xs font-black text-white uppercase tracking-[0.3em] drop-shadow-lg">
                                {language === 'ar' ? 'فن قتالي' : 'MARTIAL ART'}
                            </span>
                        </motion.div>
            ...
            <div className="container mx-auto px-4 -mt-8 relative z-10 max-w-6xl">
                <div className="bg-white dark:bg-[#1a2235]/60 backdrop-blur-xl rounded-3xl p-6 md:p-10 shadow-premium border border-gray-100 dark:border-white/5 flex flex-col lg:flex-row gap-10">
                    <div className="lg:w-2/3 text-start">
                        <h2 className="text-lg font-black text-slate-900 dark:text-white mb-4 tracking-tight">{content.descTitle}</h2>
                            ...
                            <div className="space-y-4">
                                ...
                                {content.benefits.map((item, i) => (
                                    <div key={i} className="flex items-center gap-3 text-gray-600 dark:text-gray-400 font-black text-[10px]">
                                        <div className="w-5 h-5 bg-gray-100 dark:bg-white/5 rounded-md flex items-center justify-center text-blue-500 flex-shrink-0 border border-gray-200 dark:border-white/5">
                            ...
                            <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-2xl border border-gray-100 dark:border-white/5">
                                ...
                                <div className="space-y-2">
                                    {content.schedule.map((sc, i) => (
                                        <div key={i} className="flex justify-between items-center bg-white dark:bg-white/5 p-3 rounded-xl border border-gray-100 dark:border-white/5 shadow-premium">
                    ...
                    <div className="lg:w-1/3">
                        <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-3xl sticky top-32 border border-gray-100 dark:border-white/5">
                            <div className="text-center mb-8">
                                <div className="w-16 h-16 bg-white dark:bg-white/5 rounded-2xl shadow-premium mx-auto flex items-center justify-center mb-4 text-blue-500 border border-gray-100 dark:border-white/5">
                ...
                <SportTrainers sportId="taekwondo" sportName={content.title} />
            </div>
        </div>
    );
}
