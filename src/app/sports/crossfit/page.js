                            ...
                            <div className="space-y-4">
                                ...
                                {content.benefits.map((item, i) => (
                                    <div key={i} className="flex items-center gap-3 text-gray-400 font-black text-[10px]">
                                        <div className="w-5 h-5 bg-white/5 rounded-md flex items-center justify-center text-orange-500 flex-shrink-0 border border-white/5">
                    ...
                    <div className="lg:w-1/3">
                        <div className="bg-white/5 p-6 rounded-3xl sticky top-32 border border-white/5">
                            <div className="text-center mb-8">
                                <div className="w-16 h-16 bg-white/5 rounded-2xl shadow-xl mx-auto flex items-center justify-center mb-4 text-orange-500 border border-white/5">
