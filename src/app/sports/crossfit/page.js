                ...
                <div className="bg-white dark:bg-slate-800 rounded-[3rem] p-8 md:p-16 shadow-2xl border border-gray-50 dark:border-white/5 flex flex-col lg:flex-row gap-16">
                    <div className="lg:w-2/3 text-start">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            <div className="space-y-6">
                                ...
                                {content.benefits.map((item, i) => (
                                    <div key={i} className="flex items-center gap-4 text-gray-600 dark:text-gray-300 font-bold">
                                        <div className="w-6 h-6 bg-orange-500/10 rounded-full flex items-center justify-center text-orange-500 flex-shrink-0">
                            ...
                            <div className="bg-orange-50/30 dark:bg-white/5 p-8 rounded-[2.5rem]">
                                ...
                                <div className="space-y-4">
                                    {content.schedule.map((sc, i) => (
                                        <div key={i} className="flex justify-between items-center bg-white dark:bg-slate-800 p-4 rounded-2xl border border-gray-100 dark:border-white/5">
                                            ...
                                            <span className="font-black text-orange-600">{sc.time}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                    ...
                    <div className="lg:w-1/3">
                        <div className="bg-orange-50/50 dark:bg-white/5 p-8 rounded-[3rem] sticky top-32 border border-orange-100 dark:border-white/5">
                            <div className="text-center mb-10">
                                <div className="w-24 h-24 bg-white dark:bg-slate-800 rounded-[2rem] shadow-xl mx-auto flex items-center justify-center mb-6 text-orange-600">
                                    <Zap className="w-12 h-12 fill-orange-600" />
                                </div>
