    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0a0f1a] pb-20 transition-colors relative overflow-hidden" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            ...
            <div className="relative h-[20vh] md:h-[25vh] overflow-hidden mx-6 rounded-[2.5rem] border border-white/5 shadow-2xl mt-4">
                ...
                <div className={`absolute bottom-4 ${language === 'en' ? 'left-6' : 'right-6'} text-white`}>
                    <div className={`flex flex-wrap gap-2 ${language === 'ar' ? 'justify-end' : 'justify-start'}`}>
                        {[
                            ...
                            <div key={i} className="bg-white/5 backdrop-blur-md px-3 py-1 rounded-lg flex items-center gap-1.5 border border-white/5">
