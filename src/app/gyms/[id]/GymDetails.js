                    ...
                    <div className="lg:col-span-4 flex flex-col gap-8">
                        ...
                        <div className="p-1 w-full rounded-[2.5rem] bg-gradient-to-br from-primary via-primary/80 to-blue-600 shadow-2xl shadow-primary/30 group">
                            <div className="bg-slate-950/90 backdrop-blur-3xl p-8 rounded-[2.4rem] flex flex-col items-center text-center gap-6">
                                ...
                                <button 
                                    onClick={() => {
                                        const pkg = { id: 'trial', name: language === 'ar' ? 'حصّة تجريبية' : 'Free Trial' };
                                        addToCart(pkg, { 
                                            type: 'subscription', 
                                            metadata: { 
                                                packageId: 'trial',
                                                isTrial: true,
                                                preSelectedGymId: gym.id,
                                                preSelectedGymName: gym.name
                                            } 
                                        });
                                        setIsCartOpen(true);
                                    }}
                                    className="w-full bg-primary text-white font-black py-5 rounded-2xl shadow-xl hover:scale-105 active:scale-95 transition-all text-xs uppercase tracking-[0.2em]"
                                >
